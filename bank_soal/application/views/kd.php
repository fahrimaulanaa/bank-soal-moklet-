<div class="col-md-12">
    <div class="panel panel-danger">
        <div class="panel-heading">Data Kompetensi Dasar (KD)
          <div class="tombol-kanan">
            <a class="btn btn-success btn-sm tombol-kanan" href="kd/tambah/"><i class="glyphicon glyphicon-plus"></i> &nbsp;&nbsp;Tambah</a>
          </div>
        </div>
