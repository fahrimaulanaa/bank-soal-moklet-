...
$form = array(
    ...
    'alokasi_wkt'    => array(
        ...
        'placeholder'=>'0',
        //isset($form_value['jumlah_soal']) ? 'disabled' : ''=> 'disabled',
        'value'=>set_value('alokasi_wkt', isset($form_value['alokasi_wkt']) ? $form_value['alokasi_wkt'] : '')
    ),
    'tgl_ujian'    => array(
        'name'=>'tgl_ujian',
        'size'=>'10',
        ...
        'placeholder'=>'0',
        //isset($form_value['jumlah_soal']) ? 'disabled' : ''=> 'disabled',
        'value'=>set_value('tgl_ujian', isset($form_value['tgl_ujian']) ? date('Y-m-d',strtotime($form_value['tgl_ujian'])) : '')
    ),
    'submit'   => array(
        'name'=>'submit',
    ...
    <div class="panel panel-danger">
        ...
        <div class="panel-body">
            ...
            <?php echo form_error('jumlah_soal', '<p class="field_error">', '</p>');?>
                ...
                <p>
                    <?php echo form_label('Alokasi Waktu (Menit)', 'alokasi_wkt'); ?>
                    <?php echo form_input($form['alokasi_wkt']); ?>
                </p>
            <?php echo form_error('alokasi_wkt', '<p class="field_error">', '</p>');?>

                <p>
                    <?php echo form_label('Tanggal Ujian', 'tgl_ujian'); ?>
                    <?php echo form_input($form['tgl_ujian']); ?>
                </p>
            <?php echo form_error('tgl_ujian', '<p class="field_error">', '</p>');?>
